...
void IntALU::onPrepare()
{
}

void IntALU::beforeWrite()
{
    ...
    if (this->skip)
    {
        raw("%14s: Skipping non-IntALU instruction: %s\n",
...
void IntALU::onCannotWrite()
{
}

void IntALU::testClass()
{
